...
app.post("/books/insertbook", (req, res) => {
  ...
  pool.query(sql_query, data, function (err) {
    if (err) {
      console.log(err);
    }
...
app.get("/books/:idbooks", (req, res) => {
  ...
  const data = ['idbooks', idbooks];

  pool.query(sql_query, data, function (err, data) {
    if (err) {
      console.log(err);
    }
...
app.post("/books/updatebook", (req, res) => {
  ...
  const data = ['title', title, 'pagesqty', pagesqty, 'idbooks', idbooks];
